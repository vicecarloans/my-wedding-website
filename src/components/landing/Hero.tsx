  ...
  return (
    <header className="flex flex-row text-center top-16 pt-15 h-[calc(100vh-4rem)] max-h-screen min-w-fit relative overflow-hidden">
      <div className="top-0 left-10 w-1/2 h-full">
        ...
        <animated.div
          className="absolute left-[9%] top-[0%] md:left-[20%] lg:top-[10%] lg:left-[31%] z-20"
      ...
      <div className="top-0 right-10 w-1/2 h-full">
        <animated.div
          ...
          className="absolute -top-[20%] -right-[40%] z-10 origin-[50%_10%] md:-top-[2%] md:-right-[20%] lg:-top-[5%] lg:right-[0%]"
        >
          <svg
            width="524"
            height="298"
